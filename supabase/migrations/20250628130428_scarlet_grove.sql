...
-- Puskesmas policies
CREATE POLICY "All authenticated users can read puskesmas"
  ON puskesmas
  FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "All authenticated users can manage puskesmas"
  ON puskesmas
  FOR ALL
  TO authenticated
  USING (true)
...
-- Penilaian policies
CREATE POLICY "All authenticated users can read penilaians"
  ON penilaians
  FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "All authenticated users can manage penilaians"
  ON penilaians
  FOR ALL
  TO authenticated
  USING (true)
...
-- Evaluasi policies
CREATE POLICY "All authenticated users can read evaluasis"
  ON evaluasis
  FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "All authenticated users can manage evaluasis"
  ON evaluasis
  FOR ALL
  TO authenticated
  USING (true)
...
-- Verifikasi policies
CREATE POLICY "All authenticated users can read verifikasis"
  ON verifikasis
  FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "All authenticated users can manage verifikasis"
  ON verifikasis
  FOR ALL
  TO authenticated
  USING (true)
