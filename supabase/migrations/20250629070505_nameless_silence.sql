/*
  # Sample Data Migration for PKP Monitor

  1. Sample Data
    - Insert sample puskesmas data
    - Insert sample bundle for 2024
    - Insert klasters with indikators
    - Insert scoring and target achievement details

  2. Data Structure
    - 5 sample puskesmas
    - 1 active bundle for 2024
    - 6 klasters with various indikators
    - Mix of scoring and target achievement indikators
*/
